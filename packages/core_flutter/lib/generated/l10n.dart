...
class SCommon {
  ...
  static SCommon get current {
    assert(_current != null, 'No instance of SCommon was loaded. Try to initialize the SCommon delegate before accessing SCommon.current.');
    return _current!;
  }
  ...
  static SCommon of(BuildContext context) {
    ...
    assert(instance != null, 'No instance of SCommon present in the widget tree. Did you add SCommon.delegate in localizationsDelegates?');
    return instance!;
  }
